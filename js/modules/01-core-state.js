    ...
    const initialOjtWeeklyData = {
      ...
      2: [
        ...
        },
        {
          ...
          hours: 8.0,
          task: "ประชุมติดตามความก้าวหน้าโครงการประจำสัปดาห์ (Weekly Stand-up) และประเมินผล SLA การให้บริการ",
          skill: "การสื่อสารในทีมแบบ Agile และการสะท้อนผลการทำงานรายสัปดาห์",
          blocker: "ไม่มี",
          steps: "1. นำเสนอผลการดำเนินงานสัปดาห์ที่ 2 ในการประชุม Weekly Stand-up Meeting\n2. แลกเปลี่ยนความคิดเห็นและร่วมกันระบุอุปสรรคเพื่อแก้ไข (Sprint Retrospective)\n3. บันทึกผลการสะสมเวลา OJT ครบถ้วนตามเป้าหมาย",
          tools: "Miro Board, MS Teams, Weekly Burn-down Chart",
          artifacts: "Sprint2_Meeting_Minutes.pdf, OJT_Milestone_Week2.png",
