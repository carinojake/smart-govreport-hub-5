// Module: 01-core-state.js (Smart GovReport Hub 2.5)
    ...
    const defaultOfficialMemoData = {
      ...
      date: "3 กันยายน 2569",
      subject: "รายงานผลการดำเนินงานโครงการพัฒนาระบบ Smart GovReport Hub 2.0 (เวอร์ชัน 1.0)",
      recipient: "ผู้อำนวยการกลุ่มงานสารสนเทศและพัฒนาระบบ / ผู้ควบคุมการฝึกงาน",
      origin: "ตามที่ข้าพเจ้า นายนิติพัฒน์ คุ้มวงษ์ ได้รับมอบหมายให้เข้ารับการฝึกปฏิบัติงานในหลักสูตรเตรียมความพร้อมสำหรับการจ้างงานคนพิการในหน่วยงานภาครัฐ รุ่นที่ 1 และได้รับมอบหมายภารกิจในการออกแบบและพัฒนาระบบนวัตกรรมดิจิทัล \"Smart GovReport Hub 2.0\" เพื่อยกระดับการบันทึกสมุดปฏิบัติงาน OJT และระบบคลังผลงานดิจิทัลภาครัฐ นั้น",
      factsIntro: "บัดนี้ การพัฒนาระบบ Smart GovReport Hub 2.0 (เวอร์ชัน 1.0) ได้ดำเนินการแล้วเสร็จตามแผนงาน Sprint ที่ 1–2 เป็นที่เรียบร้อยแล้ว โดยมีผลสัมฤทธิ์ที่สำคัญดังนี้:",
    ...
    const initialOjtWeeklyData = {
      ...
      4: [
        ...
        },
        {
          ...
          tools: "Executive Presentation Deck, Smart GovReport Hub 2.0 PDF Exporter",
